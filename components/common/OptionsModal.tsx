...
const OptionsModal: React.FC<OptionsProps> = ({ onClose }) => {
  ...
  return (
    <Pressable className="flex-1 justify-end" onPress={onClose}>
      <Pressable
        className="bg-white rounded-t-2xl pt-4 pb-6 px-0 w-full shadow-lg"
      ...
      >
        ...
        <View className="w-full items-center">
          <View className="w-full">
            ...
            <Pressable onPress={inviteTab} className="flex-row items-center justify-between p-3.5 rounded-lg active:bg-slate-50 w-[90%] mx-auto">
              <View className='flex-row items-center'>
                <UserPlus strokeWidth={1.8} size={22} color="#000000b3"/>
                <Text className="font-medium text-muted ml-3">Invite user</Text>
              </View>
